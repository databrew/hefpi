...
mod_recent_mean_sub_server <- function(input, output, session){
  ...
  #   # get data
  #   # TEMPORARILY COMMENT OUT CODE FOR FAKE DATA BELOW. THIS IS JUST TO GET COUNTRY NAMES. USUALLY DONE IN THE COMMENTED OUT QUESTIONS
  ...
  #                 unit_of_measure) 
  # 
  #     #TEMORARILY ADD CONDITION FOR FAKE DATA BELOW
  #     if(nrow(pd)==0){
  #       shp <- hefpi::sub_national_shp
  #       
